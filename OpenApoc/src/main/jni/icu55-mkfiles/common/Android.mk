...
# Common definitions.
#
# These were for an older version of ICU
#src_files := \
#	cmemory.c          cstring.c          \
#	cwchar.c           locmap.c           \
#	lrucache.cpp \
...
src_files := $(wildcard $(COMMON_SRC_PATH)/*.c) \
		 	 $(wildcard $(COMMON_SRC_PATH)/*.cpp) \
			 $(wildcard $(COMMON_SRC_PATH)/unicode/*.c) \
			 $(wildcard $(COMMON_SRC_PATH)/unicode/*.cpp)

# This is the empty compiled-in icu data structure
# that we need to satisfy the linker.
src_files += $(COMMON_SRC_PATH)/../stubdata/stubdata.c

c_includes := \
	$(COMMON_SRC_PATH) \
	$(COMMON_SRC_PATH)/../i18n
